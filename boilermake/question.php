...
mysql_query("insert into Poll (Question, PollDate, latitude, longitude) values ('" . mysql_real_escape_string($_POST['question']) . "', now()," . replace_null($_SESSION['user_long'], '0') . ", " . replace_null($_SESSION['user_lat'], '0') . ")")
                        or die (mysql_error());
